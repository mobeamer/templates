...
function Tile(options)
{
    ...
    this.render  = function (context, originX, originY, options)
    {
        ...
        context.drawImage(assets.getImg(this.tileSetKey).img, cropX, cropY, cropWidth, cropHeight, originX + this.drawX(), originY + this.drawY(),this.tileSize, this.tileSize);
